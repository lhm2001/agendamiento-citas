...
/**
 * Handler del Lambda "appointment_pe"
 * Procesa agendamientos para Perú desde SQS
 * Guarda los agendamientos en RDS MySQL de Perú
 */
export const handler = async (event: SQSEvent): Promise<void> => {
  const ctx = createContext('appointment-processor-pe');
